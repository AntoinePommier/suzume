	...
	return (
		<SafeAreaView style={styles.safeArea}>
			...
			<View style={styles.content}>
				...
				{__DEV__ && (
					<Pressable
						style={styles.devSpikeButton}
						onPress={() => {
							// @ts-expect-error Route types are generated by Expo on next start.
							router.push({
								pathname: "/foliate-reader",
								params: { bookId: "shika-no-ou-1" },
							});
						}}
					>
						<Text style={styles.devSpikeButtonText}>
							[DEV] Open with Foliate spike
						</Text>
					</Pressable>
				)}
